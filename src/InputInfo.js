...
const InputInfo = ({ emailValue, passwordValue, checkboxValue }) => {
  return (
    ...
    >
      <div className="flex rounded-full flex-col bg-orange-500 w-1/2 h-1/2 absolute justify-center items-center text-center align-center">
        <div className="flex font-bold text-lg text-white gap-20  text-start">
          <p className="font-bold text-lg text-black "> Email: </p>
          {emailValue}
        </div>
        <div className="flex font-bold text-lg text-white gap-10">
